...
class KeyModel {
    constructor({
        ...
        associatedCAId,
        isPinProtected} = {}) {
        this.canDelete = canDelete || null;
        this.rsaPublicParameters = rsaPublicParameters || null;
        this.csr = csr || null;
        this.csrInfo = csrInfo || null;
        this.size = size || null;
        this.keyType = keyType || null;
        this.curve = curve || null;
        this.recommendedDigestAlgorithm = recommendedDigestAlgorithm || null;
        this.keyStore = keyStore || null;
        this.keyStorePartitionName = keyStorePartitionName || null;
        this.id = id || null;
        this.subscriptionId = subscriptionId || null;
        this.name = name || null;
        this.associatedCAId = associatedCAId || null;
