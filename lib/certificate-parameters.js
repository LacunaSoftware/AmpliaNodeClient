...
class PkiParaguayCertificateParameters extends CertificateParameters {
	 ...
	 * @param {string} surnames: the surnames field of the certificate
	 * @param {string} documentType: the documentType field for the 
	 * certificate. There are some accepted values for this field in
	 * PkiParaguayDocumentTypes (@see PkiParaguayDocumentTypes)
	 * @param {string} documentNumber: the document number field of the
	 * certificate
	 * @param {string} emailAddress: the email address field of the certificate
	 * @param {string} phoneNumber: the phone number field of the certificate
	 * 
	 * @example
	...
	/**
	* Gets the organization unit value
	* @returns {string} the organization unit
	*/
	get organizationUnit() { return this._organizationUnit; }
	/**
	 * Sets the organization unit value
	 * @param {string} value the organization value
	 */
	set organizationUnit(value) { this._organizationUnit = value; }
	...
	*/
	...
	toModel() {
		...
		model['organization'] = this._organization;
		model['organizationUnit'] = this._organizationUnit;
		model['ruc'] = this._ruc;
