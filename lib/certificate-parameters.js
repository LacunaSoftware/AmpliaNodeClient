'use strict';
const { ArispRoles, CertificateFormats, PkiParaguayDocumentType } = require('./enums');
	...
	toModel() {
		...
		if (this._documentType) {
			switch (this._documentType) {
				case PkiParaguayDocumentType.CedulaDeIdentidad:
				case PkiParaguayDocumentType.Pasaporte:
					break;
				default:
