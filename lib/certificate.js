...
class BaseCertificate {
	...
	constructor(
		...
		this._contentBase64 = content || null;
	...
	getContentRaw() {
		if (!this._contentBase64) {
			return null;
		}
		return new Buffer(this._contentBase64, 'base64');
	}
	...
	setContentRaw(value) {
		this._contentBase64 = new Buffer(value).toString('base64');
	}
